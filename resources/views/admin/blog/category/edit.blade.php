<div wire:ignore.self class="modal fade" id="modal-edit-{{ $category->id }}" data-bs-backdrop="static" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                @livewire('admin.blog.category.form', ['category' => $category, 'method' => 'update'], key($category->id))
