<div wire:ignore.self class="modal fade" id="modal-edit-{{ $person->id }}" data-bs-backdrop="static" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                @livewire('admin.about.team.form', ['person' => $person, 'method' => 'update'], key($person->id))
