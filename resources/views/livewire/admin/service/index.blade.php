                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.service.create') }}" type="button" class="btn btn-primary">
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center align-items-center">
                                                ...
                                                <a href="#">
                                                    @if ($service->image)
                                                        <div class="symbol-label">
                                                            <img src="{{ Storage::url($service->image->url) }}"
                                            ...
                                            <div class="d-flex flex-column">
                                                <a class="text-gray-800 mb-1">{{ $service->name }}</a>
                                            </div>
                                        </td>
                                        <td>{{ substr($service->fragment, 0, 30) }}...</td>
                                        <td>{{ $service->view }}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.service.show', $service) }}" class="menu-link px-3"> Ver</a>
                                                </div>

                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.service.edit', $service) }}" class="menu-link px-3"> Editar</a>
                                                </div>

                                                <div class="menu-item px-3">
                                                    <a href="#"
                                                        onclick="event.preventDefault(); confirmDestroy({{ $service->id }})"
