                            ...
                            <tbody class="text-gray-600 fw-bold">
                                @foreach ($team as $person)
                                    <tr>
                                                ...
                                                <a href="#">
                                                    @if ($person->image)
                                                        <div class="symbol-label">
                                                            <img src="{{ Storage::url($person->image->url) }}"
                                                                alt="{{ $person->name }}" class="w-100" />
                                                        </div>
                                                    @else
                                                        <div
                                        ...
                                        <td>{{ $person->link_facebook }}</td>
                                        <td>{{ $person->link_linkedin }}</td>
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal"
                                                        data-bs-target="#modal-edit-{{ $person->id }}"> Editar</a>
                                                </div>

                                                <div class="menu-item px-3">
                                                    <a href="#"
                                                        onclick="event.preventDefault(); confirmDestroy({{ $person->id }})"
